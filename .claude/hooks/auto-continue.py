...
================================================================================
DO NOT EDIT THIS FILE IN YOUR PROJECT'S .claude/hooks/ DIRECTORY!

This hook is deployed by php-qa-ci and will be overwritten on updates.
To modify this hook, edit the source in:
    vendor/lts/php-qa-ci/.claude/hooks/auto-continue.py

Then commit and push changes to the php-qa-ci repository.
================================================================================
"""
