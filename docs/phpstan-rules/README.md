...
| `phpqaci.variadicOverArrayParameter` | `RequireVariadicOverArrayParameterRule` | [generic](../../rules-optional.neon)                                            | [A docblock-typed list LAST parameter (any method, not just single-param) should be variadic](require-variadic-over-array-parameter.md) |
