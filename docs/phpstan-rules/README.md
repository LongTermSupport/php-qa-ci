...
| `phpqaci.binDirTool`                         | `ForbidBinDirToolRule`                         | [Tools run from `vendor-phar/`, not the Composer bin dir](forbid-bin-dir-tool.md)                                    |
...
| `phpqaci.forbiddenAttribute`                 | `ForbidAllowMockWithoutExpectationsRule`       | [No `#[AllowMockObjectsWithoutExpectations]`](forbid-allow-mock-without-expectations.md)                             |
| `phpqaci.newDateTime`                        | `ForbidNewDateTimeRule`                        | [No direct `new DateTime` / `new DateTimeImmutable`](forbid-new-date-time.md)                                        |
| `phpqaci.emptyLanguageConstruct`             | `ForbidEmptyLanguageConstructRule`             | [No `empty()`; use an explicit type-safe check](forbid-empty-language-construct.md)                                  |
| `phpqaci.looseComparison`                    | `ForbidLooseComparisonRule`                    | [No `==` / `!=`; use `===` / `!==`](forbid-loose-comparison.md)                                                      |
| `phpqaci.deprecatedSerializable`             | `ForbidDeprecatedSerializableRule`             | [No `Serializable`; use `__serialize()` / `__unserialize()`](forbid-deprecated-serializable.md)                      |
| `phpqaci.nestedTernary`                      | `ForbidNestedTernaryRule`                      | [No nested ternary expressions](forbid-nested-ternary.md)                                                            |
...
| `phpqaci.inlinePhpstanIgnore`                | `ForbidInlinePhpstanIgnoreRule`                | [No inline `@phpstan-ignore`; use `ignoreErrors` in the config](forbid-inline-phpstan-ignore.md)                     |
| `phpqaci.mockFinalClass`                     | `ForbidMockingFinalClassRule`                  | [Mock an interface, never a final class](forbid-mocking-final-class.md)                                              |
| `phpqaci.ruleIdentifierMustBeConstant`       | `RequireRuleIdentifierConstantRule`            | [A PHPStan rule's identifier must be a class constant](require-rule-identifier-constant.md)                          |
| `phpqaci.devNamespaceInProductionSource`     | `ForbidDevNamespaceInProductionSourceRule`     | [Dev-only code belongs under `autoload-dev`](forbid-dev-namespace-in-production-source.md)                           |
| `phpqaci.requireSensitiveParameterAttribute` | `RequireSensitiveParameterAttributeRule`       | [`#[\SensitiveParameter]` on plaintext credential parameters](require-sensitive-parameter-attribute.md)              |
...
| `phpqaci.repeatedStringLiteral`      | `ForbidRepeatedStringLiteralRule`       | [generic](../../rules-optional.neon)                                            | [A string literal repeated three times in a class is an undeclared constant](forbid-repeated-string-literal.md)                                    |
| `phpqaci.ambiguousArrayDoc`          | `ForbidAmbiguousArrayDocRule`           | [generic](../../rules-optional.neon)                                            | [A docblock array type must state its keys: `list<T>` or `array<K, V>`, never `T[]` or `array<T>`](forbid-ambiguous-array-doc.md)                  |
| `phpqaci.insecureFunction`           | `ForbidInsecureFunctionsRule`           | [generic](../../rules-optional.neon)                                            | [No broken hashes, predictable randomness or unparameterised SQL](forbid-insecure-functions.md)                                                    |
| `phpqaci.debugOutputFunction`        | `ForbidDebugOutputFunctionsRule`        | [generic](../../rules-optional.neon)                                            | [No var_dump/print_r/var_export left printing](forbid-debug-output-functions.md)                                                                   |
| `phpqaci.consistentMemberDocs`       | `RequireConsistentMemberDocsRule`       | [generic](../../rules-optional.neon)                                            | [A class's constants, and its properties, are documented all or none](require-consistent-member-docs.md)                                           |
| `phpqaci.silentCatch`                | `ForbidSilentCatchRule`                 | [generic](../../rules-optional.neon)                                            | [A catch block must reference the exception it caught](forbid-silent-catch.md)                                                                     |
| `phpqaci.readonlyService`            | `RequireReadonlyServiceRule`            | [generic](../../rules-optional.neon)                                            | [A service class must be `final readonly`](require-readonly-service.md)                                                                            |
| `phpqaci.variadicOverArrayParameter` | `RequireVariadicOverArrayParameterRule` | [generic](../../rules-optional.neon)                                            | [A parameter typed `list<T>` in a docblock should be a native variadic, moved last if it is not already](require-variadic-over-array-parameter.md) |
...
| `phpqaci.factorySealed`              | `FactorySealedRule`                     | [generic](../../rules-optional.neon)                                            | [A factory-sealed class is constructed only by its factory](factory-sealed.md)                                                                     |
| `phpqaci.deprecatedPhpunitMethod`    | `ForbidDeprecatedPhpunitMethodRule`     | [generic](../../rules-optional.neon)                                            | [No PHPUnit method deprecated by the installed version](forbid-deprecated-phpunit-method.md)                                                       |
...
| `phpqaci.cronMissingInterval`        | `RequireCronIntervalInDescriptionRule`  | [symfony](../../rules-optional-symfony.neon)                                    | [A cron command must state its interval in its description](require-cron-interval-in-description.md)                                               |
| `phpqaci.requireExplicitDIAttribute` | `RequireExplicitDIAttributeRule`        | [symfony](../../rules-optional-symfony.neon)                                    | [A Symfony service must declare its DI attributes explicitly](require-explicit-di-attribute.md)                                                    |
| `phpqaci.conflictingDIAttributes`    | `RequireExplicitDIAttributeRule`        | [symfony](../../rules-optional-symfony.neon)                                    | [A service must not carry DI attributes that contradict each other](require-explicit-di-attribute.md)                                              |
| `phpqaci.magicStringAssertion`       | `ForbidMagicStringAssertionRule`        | [none — experimental](../tools/phpstan.md#experimental-rules-not-in-any-bundle) | [No magic-string assertion where an enum belongs](forbid-magic-string-assertion.md)                                                                |
...
| `phpqaci.docsProse`                                 | `Pipeline/Lane/DocsProseTool`                            | `bin/qa -t dp`           | [Documentation describes its subject, not itself](../tools/docsProse.md)                                                     |
...
| `phpqaci.opcache`                                   | `Pipeline/Lane/OpcacheTool`                              | `bin/qa -t oc`           | [The code compiles cleanly through OPcache](../tools/opcache.md)                                                             |
...
| `phpqaci.composerDependencyAnalyser`                | `Pipeline/Lane/ComposerDependencyAnalyserTool`           | `bin/qa -t cda`          | [Every declared dependency is used, and is on the right side of require/require-dev](../tools/composerDependencyAnalyser.md) |
...
| `phpqaci.deadCode`                                  | `Pipeline/Lane/DeadCodeTool`                             | `bin/qa -t dcd`          | [No member nothing reaches, tests excluded; opt-in](../tools/deadCode.md)                                                    |
...
| `phpqaci.phpcpd`                                    | `Pipeline/Lane/PhpcpdTool`                               | `bin/qa -t cpd`          | [Copy/paste report after a green run; informational](../tools/phpcpd.md)                                                     |
