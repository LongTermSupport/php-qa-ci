    ...
    public static function shipped(): self
    {
        ...
        return new self(
            ...
            [
                ...
                new ToolDefinitionDto('phpArkitect', ['arch', 'arkitect', 'phparkitect'], 'PHPArkitect architecture rules (on by default; useArkitect=0 to disable)', $staticAnalysis, false, banner: 'Running PHPArkitect (architecture rules)', supportsAgentMode: true),
