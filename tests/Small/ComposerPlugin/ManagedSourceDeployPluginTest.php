...
use LTS\PHPQA\ComposerPlugin\ManagedSourceDeployPlugin;
 ...
 * @internal
 */
#[CoversClass(ManagedSourceDeployPlugin::class)]
#[Small]
final class ManagedSourceDeployPluginTest extends TestCase
{
    ...
    #[Test]
    public function bothInstallAndUpdateRegenerateManagedSource(): void
    {
        self::assertSame(
            [
                'post-install-cmd' => 'generateManagedSource',
                'post-update-cmd'  => 'generateManagedSource',
            ],
            ManagedSourceDeployPlugin::getSubscribedEvents(),
        );
    }
}
