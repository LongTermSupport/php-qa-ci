 ...
 * @internal
 */
#[CoversClass(PhpUnitConfigVersionDetector::class)]
#[Small]
final class PhpUnitConfigVersionDetectorTest extends TestCase
{
    ...
    private PhpUnitConfigVersionDetector $detector;

    protected function setUp(): void
    {
        $this->detector = new PhpUnitConfigVersionDetector();
    }
